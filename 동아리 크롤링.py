...
text = getTextFromURL("https://news.v.daum.net/v/20201115160101327")
text = removeNewLines(text)
nouns = getNouns(text)
top_nouns = frequnecyNouns(nouns, max_result=15)
labels, frequnecies, x_array = freqeuncyToArray(top_nouns)

drawPlot(x=x_array, y=frequnecies, labels=labels)